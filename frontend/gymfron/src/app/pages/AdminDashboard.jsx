      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-400">Add, edit, and manage your gym members</p>
          </div>
          <button
            onClick={handleAddMember}
            className="flex items-center gap-2 px-6 py-3 bg-white text-black rounded-xl hover:bg-gray-200 transition-all duration-200 shadow-lg"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
            ...
            <div className="text-3xl">{members.length}</div>
          </div>
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
          ...
          <div className="bg-black border border-white/10 rounded-2xl p-8 max-w-md w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 px-6 py-3 bg-white text-black rounded-xl hover:bg-gray-200 transition-all"
                >
